"""DuckDB integration with BitPolar vector compression.

Stores compressed BitPolar codes as BLOBs in DuckDB for
memory-efficient vector storage with SQL-based querying.
"""
...
class BitPolarDuckDBStore:
    """DuckDB vector store with BitPolar compression.

    Stores compressed codes as BLOBs in DuckDB alongside JSON metadata.
    ...
    def search(
        ...
        Fetches all stored codes from DuckDB and scores them
